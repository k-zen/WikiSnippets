...
/**
 * German language text analyzer.
 *
 * @author K-Zen
 */
public class GermanAnalyzer extends WSAnalyzer {
    ...
    public GermanAnalyzer() {
        this.stopWords = StopFilter.makeStopSet(StopWords.GERMAN_STOP_WORDS);
    }
    ...
    public String toString() {
        return "German Language Analyzer";
    }
}
